...
export function Sidebar({ workspace, activeView, onViewChange, chats, selectedChatId, onNewChat, onSelectChat, selectedPath, onSelectNote, onChangeWorkspace, onWorkspaceChanged, onGenerateNote, onDelete }: SidebarProps) {
